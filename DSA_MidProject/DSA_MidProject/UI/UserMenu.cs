...
namespace DSA_MidProject
{
    public partial class UserMenu : Form
    {
        ...
        private void InitializeCustomComponents()
        {
            ...
            noPostsLabel.Text = "No posts from friends yet.\nFollow more people to see their posts here!";
        ...
        private void LoadFriendsPosts()
        {
            ...
            try
            {
                List<FriendUser> friends = Program.AppData.friendCrud.GetFriendsWithDetails(LoggedInUser.userID);
                ...
                List<int> friendIds = friends.Select(f => f.UserID).ToList();
            ...
            {
                MessageBox.Show($"Error loading friends posts: {ex.Message}", "Error",
        ...
        {
            loadingLabel.Visible = false;
            noPostsLabel.Text = "You haven't added any friends yet.\nVisit the Friends section to connect with people!";
            noPostsLabel.Visible = true;
            postsPanel.Visible = false;
        }

        private void DisplayFriendsPosts()
        {
            ...
            {
                Panel postPanel = CreateFriendPostPanel(post, yPosition, postWidth, postHeight);
        ...
        private Panel CreateFriendPostPanel(Post post, int yPosition, int width, int height)
        {
            ...
            if (post.UserID != LoggedInUser.userID)
            {
                ...
                profileButton.Tag = new ProfileButtonTag { UserID = post.UserID, IsFriend = true };
        ...
        private void EnhancedProfileButton_Click(object sender, EventArgs e)
        {
            ...
            if (profileButton != null && profileButton.Tag is ProfileButtonTag tag)
            {
                ...
                if (user != null)
                {
                    ShowFriendProfileDialog(user);
                }
            }
        }

        private void ShowFriendProfileDialog(User user)
        {
            ...
            removeFriendBtn.Text = "Remove";
            removeFriendBtn.Size = new Size(150, 35);
            removeFriendBtn.Location = new Point(20, 155);
            removeFriendBtn.BackColor = Color.LightCoral;
            removeFriendBtn.ForeColor = Color.DarkRed;
            removeFriendBtn.Font = new Font("Arial", 10, FontStyle.Bold);
            removeFriendBtn.Click += (s, e) =>
            {
            ...
            mainPanel.Controls.Add(removeFriendBtn);
